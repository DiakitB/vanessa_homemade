export default function CartItem({ item }) {
   ...
   console.log(List)
    ...
    return <div>
       {List?.map((ele, index) => <div className=" block w-full  rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(247, 247, 247, 0.07),0_10px_20px_-2px_rgba(223, 201, 201, 0.04)] dark:bg-neutral-700">
  <ul className="w-full  ">
    <li
      className="w-full border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50 text-white">
     {index +1}-{ele}
    </li>
